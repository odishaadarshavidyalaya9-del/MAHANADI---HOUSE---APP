...
import { Home, CalendarCheck, MessageSquare, User as UserIcon } from 'lucide-react';

export type TabType = 'home' | 'attendance' | 'chat' | 'calls' | 'me';
        ...
        {tabs.map(tab => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center w-16 py-1 transition-all duration-200 group ${
                isActive 
            ...
            >
              ...
              <span className={`text-[11px] mt-1 tracking-tight transition-all ${
